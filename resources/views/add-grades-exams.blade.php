...
<div class="container pt-5">
    ...
    <div class="back-button">
        <a href="{{ route('exams.index') }}" class="btn btn-secondary btn-lg rounded-circle" style="width: 50px; height: 50px; display: flex; align-items: center; justify-content: center;">
    ...
    <form action="{{ route('exams.storeGrades', ['courseId' => $course->id]) }}" method="POST">
        @csrf
