                        ...
                        <form id="addDailyWorkForm" action="{{ route('dailyWorks.store') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <select id="add-course" name="course_id" class="form-control"
                                    onchange="updateAddCycleOptions()" required>
                                    <option value="">Seleccione un curso</option>
                                    @foreach ($courses as $course)
                                        <option value="{{ $course->id }}" data-cycles="{{ $course->cycle }}">
                                            {{ $course->name }} - {{ $course->grade }} - {{ $course->institution }} -
                        ...
                        <form id="editDailyWorkForm" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select id="edit-course" name="course_id" class="form-control"
                                    onchange="updateEditCycleOptions()" required>
                                    <option value="">Seleccione un curso</option>
                                    @foreach ($courses as $course)
                                        <option value="{{ $course->id }}" data-cycles="{{ $course->cycle }}">
                                            {{ $course->name }} - {{ $course->grade }} - {{ $course->institution }} -
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($dailyWork->file_path)
                                        <a href="{{ asset('storage/' . $dailyWork->file_path) }}" target="_blank">Ver
                                            Archivo</a>
                                    @else
                                        No hay archivo
                                    @endif
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('dailyWorks.destroy', $dailyWork->id) }}" method="POST"
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center">No hay trabajos cotidianos registrados.</td>
                                <!-- Actualizar colspan -->
                            </tr>
                        @endforelse
                    </tbody>
